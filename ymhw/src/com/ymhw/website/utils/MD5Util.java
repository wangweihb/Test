...
public class MD5Util
{
	...
	public static String MD5_SALT = "ymhw_oswin";
	...
	/**
	 * shiro实现的md5加密（加入salt，不能被解密）
	 * @param source
	 * @param salt
	 * @return
	 */
	public static String shiroMD5(String source, String salt) 
	{
	 ...
	 * @return
	 */
	public static String shiroMD5(String source) 
	{
		return shiroMD5(source, MD5_SALT);
	}

	public static void main(String[] args)
	{
		System.out.println(MD5("12345678"));
		System.out.println(shiroMD5("dfzc8888"));
		System.out.println(shiroMD5("12345678"));
	}
}
