...
import com.ymhw.website.config.Config;

/**
 * 在数据库表有任何变动时，运行一下 main 方法，极速响应变化进行代码重构
 */
public class YmhwGenerator
{
...
//		return c3p0Plugin.getDataSource();
	...
	{
		// base model 所使用的包名
		String baseModelPackageName = "com.ymhw.website.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath()
				+ "/../src/com/ymhw/website/model/base";

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.ymhw.website.model";
