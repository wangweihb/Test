	...
	var v = function() {
		...
		w = function() {
			var b = function(a, b) {
				...
				m = function(a) {
					var b = "<tr><td>鈱� + B</td><td>" + a.font.bold + "</td></tr><tr><td>鈱� + I</td><td>" + a.font.italic + "</td></tr><tr><td>鈱� + U</td><td>" + a.font.underline + "</td></tr><tr><td>鈱� + 鈬� + S</td><td>" + a.font.strikethrough + "</td></tr><tr><td>鈱� + \\</td><td>" + a.font.clear + "</td></tr>";
					return l(a.shortcut.textFormatting, b)
				},
				n = function(a) {
					var b = "<tr><td>鈱� + Z</td><td>" + a.history.undo + "</td></tr><tr><td>鈱� + 鈬� + Z</td><td>" + a.history.redo + "</td></tr><tr><td>鈱� + ]</td><td>" + a.paragraph.indent + "</td></tr><tr><td>鈱� + [</td><td>" + a.paragraph.outdent + "</td></tr><tr><td>鈱� + ENTER</td><td>" + a.hr.insert + "</td></tr>";
					return l(a.shortcut.action, b)
				},
				o = function(a) {
					var b = "<tr><td>鈱� + 鈬� + L</td><td>" + a.paragraph.left + "</td></tr><tr><td>鈱� + 鈬� + E</td><td>" + a.paragraph.center + "</td></tr><tr><td>鈱� + 鈬� + R</td><td>" + a.paragraph.right + "</td></tr><tr><td>鈱� + 鈬� + J</td><td>" + a.paragraph.justify + "</td></tr><tr><td>鈱� + 鈬� + NUM7</td><td>" + a.lists.ordered + "</td></tr><tr><td>鈱� + 鈬� + NUM8</td><td>" + a.lists.unordered + "</td></tr>";
					return l(a.shortcut.paragraphFormatting, b)
				},
				p = function(a) {
					var b = "<tr><td>鈱� + NUM0</td><td>" + a.style.normal + "</td></tr><tr><td>鈱� + NUM1</td><td>" + a.style.h1 + "</td></tr><tr><td>鈱� + NUM2</td><td>" + a.style.h2 + "</td></tr><tr><td>鈱� + NUM3</td><td>" + a.style.h3 + "</td></tr><tr><td>鈱� + NUM4</td><td>" + a.style.h4 + "</td></tr><tr><td>鈱� + NUM5</td><td>" + a.style.h5 + "</td></tr><tr><td>鈱� + NUM6</td><td>" + a.style.h6 + "</td></tr>";
				...
				v = function(a) {
					return e.isMac && (a = a.replace("CMD", "鈱�").replace("SHIFT", "鈬�")), a.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")
				},
				w = function(b, c, d) {
			...
			this.createLayoutByAirMode = function(b, c) {
				...
				var s = a(m).prependTo(d),
					v = c.keyMap[e.isMac ? "mac" : "pc"];
				x(s, c), w(s, v, "bottom");
